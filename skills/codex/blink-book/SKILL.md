...
In writing and review, prioritise ease of understanding over brevity. Include context, concrete actions and explanatory steps when they help the reader follow the idea, even when this makes the passage longer. Tightening should remove repetition and irrelevant material while preserving details that reduce the reader’s need to infer or reconstruct meaning.

## Mandatory independent summary review

For summary reviews, use the existing review notes to show how the most vulnerable passage supports the key idea or enables the requested judgement or action. Flag a material gap if this requires inventing reasoning, facts or instructions.
